...
Build personal or enterprise softwares and make money out of it. Clearly mark the boundary of responsibility by compiling.`,
      },
      {
        ...
        text: `<h3>Less Complications</h3>
Installing developer tools never pollute your global <code>node_modules</code> or gem set any more. Just use the enclosed executables.
<h3>Stay Edge-cutting</h3>
By using enclosed executables with AutoUpdate enabled, you can stay up to date easily without checking news for new releases.
<h3>More Productive</h3>
Pre-compiling source code to byte code boosts the start-up speed of your developer tools.`,
      },
      {
...
Easily give each machine the same copy. No more error-prone execution of N*M steps for running a M-step process on N machines.`,
      },
    ];
