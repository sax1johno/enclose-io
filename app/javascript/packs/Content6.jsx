    ...
    const childrenData = [
      {
        ...
        img: <img width="100%" src={window.enclose_io.dist_desktop_png} />,
...
Free non-technical users from confusing warnings, if not errors, generated by npm or gem installers.
...
Build personal or enterprise softwares and make money out of it. Clearly mark the boundary of responsibility by compiling.`,
      },
      {
        ...
        img: <img width="100%" src={window.enclose_io.dist_workstation_png} />,
...
Pre-compiling source code to byte code boosts the start-up speed of the developer tools.`,
      },
      {
        ...
        img: <img width="100%" src={window.enclose_io.dist_server_png} />,
...
Just toss your application executable to each server of the cluster and it's done.
<h3>Error-free Cluster</h3>
No more error-prone executions of N*M steps when running a M-step deployment process on N machines.`,
      },
    ];
